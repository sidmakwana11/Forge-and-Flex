        ...
        <div className="container page-padding py-[12rem] ">
          ...
          <div className="flex flex-col text-center relative items-center">
            ...
            <p className="text-[#646464] font-medium text-[15px] ">
              Forge&Flex an unknown printer took a galley of type and scrambled
              <br /> make a type specimen book.
            </p>
          </div>
          {/* pricing boxes */}
          <div className="flex gap-10 mt-32 relative z-[2] md1000:flex-col md1000:items-center ">
            <PricingBox img={Img1} price="60" level="Beginners" />
            <PricingBox img={Img2} price="95" level="Intermediate"/>
            <PricingBox img={Img3} price="120" level="Advanced"/>
          </div>
          <img
            src={BgDumbell}
            alt="bg_icon"
